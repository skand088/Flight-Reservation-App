...
/**
 * Panel for agents to view all reservations with search and filter capabilities
 */
public class AllReservationsPanel extends JPanel {
    ...
    private void addReservationToTable(Reservation reservation) {
        ...
        tableModel.addRow(new Object[]{
                ...
                reservation.getCustomer() != null ? 
                        reservation.getCustomer().getUser().getUsername() : "N/A",
                reservation.getFlight() != null ? 
                        reservation.getFlight().getFlightNumber() : "N/A",
                reservation.getFlight() != null ? 
                        reservation.getFlight().getDepartureTime().format(formatter) : "N/A",
    ...
    private void viewReservationDetails() {
        ...
        if (reservation.getFlight() != null) {
            ...
            details.append("Departure: ").append(reservation.getFlight().getDepartureTime().format(formatter)).append("\n");
