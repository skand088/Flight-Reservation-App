...
import com.flightreservation.dao.PassengerDAO;
...
/**
 * Panel for agents to modify existing reservations
 */
public class ModifyReservationPanel extends JPanel {
    ...
    private void displayReservationDetails() {
        ...
        // Passengers panel with edit capability
    ...
    private JPanel createPassengersPanel() {
        ...
        // Create a panel for each passenger
    ...
    private void changeSeat() {
        ...
        if (selectedSeat != null) {
            // Extract seat number from selection
            ...
            if (newSeat != null) {
                // Get the first passenger (assuming single passenger for now)
                ...
                if (reserved) {
                    JOptionPane.showMessageDialog(this,
                            ...
                            "Success",
                            JOptionPane.INFORMATION_MESSAGE);
                    searchReservation(); // Refresh display
                } else {
                    JOptionPane.showMessageDialog(this,
